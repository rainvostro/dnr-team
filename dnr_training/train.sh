...
python training.py $PREPROCESS_IMAGES_TRAIN_DIRECTORY $PREPROCESS_IMAGES_VAL_DIRECTORY $PREPROCESS_IMAGES_TRAIN_CLASS0_DIRECTORY $PREPROCESS_IMAGES_TRAIN_CLASS1_DIRECTORY $PREPROCESS_IMAGES_VAL_CLASS0_DIRECTORY $PREPROCESS_IMAGES_VAL_CLASS1_DIRECTORY $MODEL_STATE_DIRECTORY
